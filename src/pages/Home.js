            ...
            <div className="home-content col-12 p-0">
                ...
                <div className="home-section col-12 py-5 d-flex doughnut-section">
                    ...
                    <div className="col-6 facteurs">
                        ...
                        <p>Et ses conséquences peuvent évidemment représenter un lourd fardeau pour la vie de tous les jours: fatigue importante, tendance à somnoler durant la journée, troubles de l’attention et de la mémoire, manque de concentration, maux de tête, nervosité, irritabilité...
                        </p>
                    </div>
                </div>
